...
<figure>
  <img src="geocode-result.png" alt="my alt text"/>
...
<figure>
  <img src="accuracy.png" alt="my alt text"/>
</figure>
...
![Donors throughout the continental United States](donors.png)  

![Exact (grey) and non-exact (blue) matches in the Michigan area](donors-accuracy.png)  
